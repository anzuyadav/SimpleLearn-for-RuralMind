...
include_once('../database.php');
 ...
 $stuOcc = $row["student_occ"];
 $stuImg = $row["student_image"];
}
 ...
 if(isset($_REQUEST['updateStuNameBtn'])){
  if(($_REQUEST['stuName'] == "")){
   ...
   $sql = "UPDATE student SET student_name = '$stuName', student_occ = '$stuOcc', student_image = '$img_folder' WHERE student_email = '$stuEmail'";
